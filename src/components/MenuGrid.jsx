      ...
      {items.map((item, index) => {
        ...
        return (
          ...
          >
            ...
            <div className="absolute inset-0 top-1/4 rounded-full bg-orange-600/0 blur-3xl transition-all duration-700 group-hover:bg-orange-600/20" />
            ...
            <div className="relative aspect-[4/3] w-full flex items-center justify-center p-4 overflow-visible">
              <img
                src={item.image}
                alt={item.name}
                className={`relative z-10 h-full w-full object-contain animate-float transition-all duration-700 group-hover:scale-[1.15] drop-shadow-[0_20px_40px_rgba(255,107,0,0.2)] ${
                  isDarker
            ...
            <div className="flex flex-1 flex-col justify-between p-6 pt-2 bg-transparent relative z-20">
              <div className="text-center">
                ...
                <p className="mt-2 text-sm text-gray-500 font-medium tracking-widest uppercase opacity-0 -translate-y-2 group-hover:opacity-100 group-hover:translate-y-0 transition-all duration-500">
              ...
              <div className="mt-8 flex items-center justify-center">
                <button
                  ...
                  className="flex h-12 w-full max-w-[160px] items-center justify-center rounded-full bg-white/5 text-white/80 transition-all duration-500 hover:bg-orange-500 hover:text-white hover:shadow-[0_0_20px_rgba(255,107,0,0.6)] opacity-0 translate-y-4 group-hover:opacity-100 group-hover:translate-y-0"
